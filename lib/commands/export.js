...
function execute(done) {
    ...
    shell.exec(`docker run -it 
                    --mount type=bind,source="$(pwd)/${Options.images}",target=/app/images 
                    --mount type=bind,source="$(pwd)/${Options.audio},target=/app/sound.mp3 
                    --mount type=bind,source="$(pwd)",target=/app/output skipdaddy/bbkcli:develop 
